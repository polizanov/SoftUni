...
SELECT  e.first_name, e.last_name, e.hire_date, d.name AS `deparment_name`
FROM `employees` AS e
JOIN `departments` AS d ON e.department_id = d.department_id
...
SELECT e.employee_id, e.first_name, m.employee_id AS `manager_id`, m.first_name AS `menager_name`
FROM `employees` AS e
